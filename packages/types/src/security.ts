...
export const SECURITY_EVENT_TYPES = {
  ...
  PROGRESSIVE_BAN_APPLIED: 'PROGRESSIVE_BAN_APPLIED',
  REPEATED_VIOLATION_DETECTED: 'REPEATED_VIOLATION_DETECTED',
  ...
  PRICE_SOURCE_FAILOVER: 'PRICE_SOURCE_FAILOVER',
  ...
  // LP Limit Protection
  LOAN_LP_LIMIT_EXCEEDED: 'LOAN_LP_LIMIT_EXCEEDED',
  LOAN_LP_CHECK_FAILED: 'LOAN_LP_CHECK_FAILED',
  LOAN_LP_LIMIT_WARNING: 'LOAN_LP_LIMIT_WARNING',
  
  // Direct Program Access Detection
  LOAN_CREATED_OUTSIDE_BACKEND: 'LOAN_CREATED_OUTSIDE_BACKEND',
  LOAN_REPAID_OUTSIDE_BACKEND: 'LOAN_REPAID_OUTSIDE_BACKEND',
  PROGRAM_DIRECT_ACCESS_DETECTED: 'PROGRAM_DIRECT_ACCESS_DETECTED',
  ...
  TOKEN_VERIFICATION_BLOCKED: 'TOKEN_VERIFICATION_BLOCKED',
  TOKEN_VERIFICATION_MANUAL_REQUEST: 'TOKEN_VERIFICATION_MANUAL_REQUEST',
  TOKEN_VERIFICATION_APPROVED: 'TOKEN_VERIFICATION_APPROVED',
  TOKEN_VERIFICATION_REJECTED: 'TOKEN_VERIFICATION_REJECTED',
  TOKEN_VERIFICATION_LP_CHECK_FAILED: 'TOKEN_VERIFICATION_LP_CHECK_FAILED',
} as const;